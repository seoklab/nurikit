...
TEST(GuessTypesTest, Tyrosine) {
  ...
  // Taken from pdb standard AA data
  MatrixX3d pos(mol.size(), 3);
  pos << 5.005, 5.256, 15.563,  //
      5.326, 6.328, 16.507,     //
      4.742, 7.680, 16.116,     //
      4.185, 8.411, 16.947,     //
      6.836, 6.389, 16.756,     //
