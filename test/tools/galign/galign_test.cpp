...
namespace {
TEST(GAlign, Rigid) {
  Molecule templ = internal::must_parse(
      read_smiles("O=C(C1CCC(CC(C)OC)CC1)c2cc3c(CC)ccc(C(C)C)c3cc2.Cl.[H][H]"));
  ...
  GARigidMolInfo tinfo(templ, tconf);
